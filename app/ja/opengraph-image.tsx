...
export const alt = 'SO101 模倣学習ガイド'
export const size = { width: 1200, height: 630 }
export const contentType = 'image/png'

export default async function OpengraphImageJa() {
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, fontSize: 28 }}>
          ...
          <span style={{ opacity: 0.9 }}>LVJIN ROBOTICS · 身体性 AI 学習プラットフォーム</span>
        </div>
        ...
        <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 32, fontSize: 32, opacity: 0.75, maxWidth: 900 }}>
            環境構築から ACT モデルのデプロイまで、ロボットアーム模倣学習の実践ガイド
          </div>
          ...
          >
            {['9 章構成', 'LeRobot', 'ACT', '日本語実践'].map((tag) => (
              <div
                key={tag}
                style={{
                  padding: '10px 20px',
